...
const AddtoLog=()=>{
  axios.post('https://sprittle-assignment-server0.vercel.app/api/AddActivity',{
  ...
  axios.post('https://sprittle-assignment-server0.vercel.app/api/delelte/StudnetPara',{
    id:props.id
  })
